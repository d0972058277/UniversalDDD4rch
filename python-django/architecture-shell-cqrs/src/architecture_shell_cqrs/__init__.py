...
from architecture_shell_cqrs.behaviors import IPipelineBehavior  # Base protocol from behaviors.py
...
# Concrete behaviors are available from architecture_shell_cqrs.concrete_behaviors submodule
# Import like: from architecture_shell_cqrs.concrete_behaviors import UnitOfWorkBehavior
